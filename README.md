...
<p><em>Founding full-stack engineer. Recent work: idea harvesting, AI method labs, Figma agent memory, research harnesses, CLIs, portfolio tests, Dune RAG, git onboarding, workforce APIs, and HF agents.</em></p>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=3000&pause=1000&color=58A6FF&width=500&lines=Idea+harvesting+%7C+AI+method+labs+%7C+Figma+agent+memory;Research+harnesses+%7C+small+CLIs+%7C+portfolio+tests;Dune+RAG+%7C+git+onboarding+%7C+workforce+APIs+%7C+HF+agents)](https://git.io/typing-svg)
...
<!-- LIVE_STATS:START -->
**Live contribution total:** **13,765** (last refreshed 2026-08-12 UTC)
<!-- LIVE_STATS:END -->
...
**Languages:** Python and TypeScript are the center. JavaScript and Shell handle CLIs, scripts, and repo glue. SQL stays close to the backend.

**Frontend:** React · Next.js · Tailwind. Portfolio experiments and git-history onboarding. UI tests when they earn their keep.

**Backend:** FastAPI · Temporal · Node.js tooling. Research harnesses, issue harvesting, CLIs, and workforce APIs.

**Databases:** PostgreSQL · SQLAlchemy · Qdrant. Relational state first; vectors only when retrieval needs them.
...
**Domain:** idea harvesting · AI method labs · Figma agent memory · research harnesses · small CLIs · portfolio experiments · Dune RAG · git-history onboarding · workforce APIs · Hugging Face agents.
