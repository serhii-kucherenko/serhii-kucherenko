...
<p><em>Founding full-stack engineer. Recent work: idea harvesting, AI method labs, Figma agent memory, research loops, CLIs, portfolio experiments, RAG, git onboarding, workforce APIs, and HF agents.</em></p>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=3000&pause=1000&color=58A6FF&width=500&lines=Idea+harvesting+%7C+AI+method+labs+%7C+Figma+agent+memory;Research+loops+%7C+small+CLIs+%7C+portfolio+experiments;Git+onboarding+%7C+Dune+RAG+%7C+workforce+APIs+%7C+HF+agents)](https://git.io/typing-svg)
...
<!-- LIVE_STATS:START -->
**Live contribution total:** **13,564** (last refreshed 2026-08-07 UTC)
<!-- LIVE_STATS:END -->
...
**Languages:** Python and TypeScript carry most recent work. JavaScript and Shell handle CLIs, scripts, and repo glue. SQL stays backend plumbing.

**Frontend:** React · Next.js · Tailwind. Portfolio variants, git-history onboarding, and UI tests when useful.
