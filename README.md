...
<p><em>Founding full-stack engineer. Recent repos: AI-dev research loops, RAG agents, git-history onboarding, FastAPI/Temporal APIs, auth docs.</em></p>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=3000&pause=1000&color=58A6FF&width=500&lines=AI-assisted+dev+%7C+RAG+agents+%7C+memory;Git+history+onboarding+%7C+auth+docs;FastAPI+workflows+%7C+Next.js+apps)](https://git.io/typing-svg)
...
**Languages:** Python does most of the work. TypeScript / JavaScript handles dashboards and docs. SQL appears when APIs need state.

**Frontend:** React · Next.js · Tailwind. Local dashboards, docs sites, habit apps.

**Backend:** FastAPI · Node.js · Temporal. API labs, workers, research harnesses, audit trails.

**Databases:** PostgreSQL · SQLite · SQLAlchemy · Qdrant. Vector search when retrieval needs it.

**Infra:** Vercel · Docker · CI/CD · pnpm/Turbo monorepos. Temporal when workflows matter.
...
**Domain:** AI-assisted dev research · script RAG · git history onboarding · AI agents · agent memory · workforce APIs · auth docs
