...
<p><em>Founding full-stack engineer. Recent work: idea harvesting, AI method labs, Figma agent memory, research loops, small CLIs, portfolio experiments, Dune RAG, git onboarding, workforce APIs, and HF agents.</em></p>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=3000&pause=1000&color=58A6FF&width=500&lines=Idea+harvesting+%7C+AI+method+labs+%7C+Figma+agent+memory;Research+loops+%7C+small+CLIs+%7C+portfolio+experiments;Dune+RAG+%7C+git+onboarding+%7C+workforce+APIs+%7C+HF+agents)](https://git.io/typing-svg)
...
<!-- LIVE_STATS:START -->
**Live contribution total:** **13,891** (last refreshed 2026-08-19 UTC)
<!-- LIVE_STATS:END -->
...
**Languages:** Python and TypeScript do most of the work. JavaScript and Shell cover CLIs, scripts, and repo glue. SQL is backend plumbing.

**Frontend:** React · Next.js · Tailwind. Portfolio experiments, onboarding UIs, and tests that earn their keep.
...
**Infra:** Vercel · Docker · CI/CD · pnpm/Turbo · uv. Bash for setup. Playwright, pytest, and Vitest for proof.
...
**Domain:** idea harvesting · AI method labs · Figma agent memory · research loops · small CLIs · portfolio experiments · Dune RAG · git-history onboarding · workforce APIs · Hugging Face agents.
