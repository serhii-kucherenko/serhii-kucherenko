...
**Languages:** Python is the default lately. TypeScript / JavaScript cover dashboards, docs, and older apps. SQL shows up when state needs shape.

**Frontend:** React · Next.js · Tailwind. Mostly docs sites, local dashboards, and small apps.
